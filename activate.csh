...
set _KERL_PATH_REMOVABLE = "/Users/wm/.asdf/installs/erlang/23.3.1/bin"
...
set _KERL_MANPATH_REMOVABLE = "/Users/wm/.asdf/installs/erlang/23.3.1/lib/erlang/man:/Users/wm/.asdf/installs/erlang/23.3.1/man"
set _KERL_SAVED_MANPATH = "$MANPATH"
setenv MANPATH "${_KERL_MANPATH_REMOVABLE}:$MANPATH"

setenv REBAR_PLT_DIR "/Users/wm/.asdf/installs/erlang/23.3.1"

set _KERL_ACTIVE_DIR = "/Users/wm/.asdf/installs/erlang/23.3.1"

set _KERL_ERL_CALL_REMOVABLE = /Users/wm/.asdf/installs/erlang/23.3.1/lib/erl_interface-4.0.2/bin
setenv PATH "${_KERL_ERL_CALL_REMOVABLE}:$PATH"

if ( -f "/Users/wm/.asdf/plugins/erlang/kerl-home/.kerlrc.csh" ) then
    source "/Users/wm/.asdf/plugins/erlang/kerl-home/.kerlrc.csh"
endif
...
if ( $?KERL_ENABLE_PROMPT ) then
    ...
    set PROMPT = $(echo "$FRMT" | sed 's^%RELEASE%^23.3.1^;s^%BUILDNAME%^asdf_23.3.1^')
    set prompt = "$PROMPT$prompt"
endif

if ( -d "/Users/wm/.asdf/installs/erlang/23.3.1/lib/docsh" ) then
    setenv DOCSH_USER_DEFAULT "/Users/wm/.asdf/installs/erlang/23.3.1/lib/docsh/user_default"
    ...
    if ( -f "$HOME/.erlang" ) then
        if ( $?KERL_DOCSH_DOT_ERLANG == 0 ) then
            ...
            echo "from /Users/wm/.asdf/installs/erlang/23.3.1/lib/docsh/dot.erlang"
            echo "and export KERL_DOCSH_DOT_ERLANG=exists to suppress this warning."
        endif
    else
        ln -s "/Users/wm/.asdf/installs/erlang/23.3.1/lib/docsh/dot.erlang" "$HOME/.erlang"
